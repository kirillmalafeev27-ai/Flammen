...
const ui = {
    ...
    showOutcome(state, targetGame) {
        const titles = {
            ...
            wrong_door: ['СУД ДВЕРЕЙ', '#ff5555', 'Неверная дверь. Повтор с прежней позиции — уровень и двери те же.'],
            burned: ['СГОРЕЛИ', '#ff7733', 'Повтор с прежней позиции — уровень и двери те же.']
        };
